...
import com.madantiwari.esoftwarica.models.User;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (localUserList.size() == 0) {
            localUser.setName("Madan");
            localUser.setAge("25");
            localUser.setAddress("Gongabu");
            ...
            LocalUser localUser2 = new LocalUser();
            localUser2.setName("Rose");
            localUser2.setAge("25");
            localUser2.setAddress("Dillibajar");
